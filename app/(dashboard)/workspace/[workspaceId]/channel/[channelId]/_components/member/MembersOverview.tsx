                ...
                <div className="p-0">
                    ...
                    <div className="p-3 border-b">
                        <div className="relative">
                            <Search className="size-4 absolute left-3 top-1/4 tansform-translate-y-/1-2 text-muted-foreground" />
                            <Input value={search} onChange={(e)=>setSearch(e.target.value)} className="pl-9 h-8" placeholder="Seach members..." />
                        </div>
                    </div>
                    {/* Members */}
