...
export function ThreadSidebar({user}:ThreadSidebarProps) {
    ...
    const { data, isLoading } = useQuery(orpc.message.thread.list.queryOptions({
        input: {
    ...
    useEffect(() => {
        ...
        // purpose is check any DOM changes within the container itself (eg. images loading, content updates)
                        ...
                        <div className="p-4 border-b bg-muted/20">
                            <div className="flex space-x-3">
                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <SafeContent content={JSON.parse(data.parent.content)} className="text-sm wrap-break-word prose dark:prose-invert max-w-none" />
                                </div>
                            </div>
                        </div>
                        {/* thread replies */}
