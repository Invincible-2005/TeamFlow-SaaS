                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className="mx-auto mt-8 max-w-3.5xl text-balance text-5xl max-md:font-semibold md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                                ...
                                <TextEffect
                                    ...
                                    Tailflow organizes conversations into channels with threads, is realtime anduses AI to keep teams in sync.
                                </TextEffect>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs **:fill-foreground mx-auto mt-12 grid max-w-2xl grid-cols-3 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14 md:grid-cols-4">
                            ...
                            <div className="flex items-center gap-2 justify-center">
                                <Claude className="mx-auto h-5 w-full" /> <p>Claude</p>
                            </div>
                        </div>
                    </div>
                </section>
