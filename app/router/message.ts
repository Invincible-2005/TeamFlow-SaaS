...
function  groupReactions(reactions: {emoji:string; userId:string}[], userId:string):GroupedReactionSchemaType[]{
...
export const createMessage = base
    ...
    .handler(async({input,context,errors})=>{
        // verify the channel belongs to the user organization
...
export const toggleReaction=base
 ...
 .route({
    method: 'POST',
    path:'/message/:messagId/reactions',
        ...
        data:[
            {
                ...
                userName: context.user.given_name ?? 'Jhon Doe',
