...
export class Chat extends Server {
  ...
  onClose(connection: Connection){
    console.log(`User dissconnected: ${connection.id}`);
    this.updateUsers();
  }
  ...
  updateUsers(){
    ...
    // Use partysevers built-in boradcast method
...
// it directs our incoming request to our chat durable object instances
export default {
